        ...
        override fun createContents(parent: Composite?): Control {
            ...
            tree.addListener(SWT.SetData) {
                ...
                if (item.parentItem == null) {
                    ...
                    item.setText(arrayOf(monitorInfo.szDevice.joinToString(""), "", "", monitor.toString().split("@")[1], ""))
                    ...
                    if ((item.parentItem.data as List<*>)[0] is WinDef.HWND) {
                        ...
                        item.setText(arrayOf(WinUtil.getTitle(window), WinUtil.getClass(window), process.value.toString(), window.toString().split("@")[1], thread.toString()))
